...
function Chatwind({ wind }: { wind: WindInfo }) {
	...
	return (
		<div className="chat-window1">
			...
			{toggle === false && (
				<div className="chat-window1-expand">
					<div
						className="chat-window1-title"
				...
				<div className="chat-expanded">
					<div className="chat-header">
						...
						<svg
							...
							onClick={() => openchat("Nouveau message")}
						/>
					</div>
